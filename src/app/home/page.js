...
const Home = () => {
  ...
  const steps = [
    {
      ...
      detail:
        "Find styles based on your vibe, trends, and seasons — from streetwear to minimal.",
    },
    {
      ...
      detail:
        "Pick colors, sizes, fonts, and add personal touches to match your personality.",
    },
    {
      ...
      detail:
        "Shortlist looks you love and revisit them anytime — easy and organized.",
    },
    {
      ...
      detail:
        "Seamless checkout with multiple payment options and smooth order tracking.",
    },
    {
      ...
      detail:
        "We ship quickly and safely — unbox happiness in just a few days.",
    },
  ];
  ...
  const features = [
    ...
    },
    {
      ...
      title: "24/7 Support",
      description: "Always here for you — any question, anytime, anywhere.",
    },
    {
      icon: <FaStar className="text-3xl" />,
      title: "Top-rated Quality",
      description:
        "Only premium fabrics and craftsmanship for a long-lasting impression.",
    },
    {
      icon: <FaPalette className="text-3xl" />,
      title: "Unique Designs",
      description:
        "Express yourself with hand-picked, bold, and diverse aesthetics.",
    },
    {
      icon: <FaRecycle className="text-3xl" />,
      title: "Eco-Friendly Fashion",
      description:
        "Style with responsibility — sustainable and conscious collections.",
    },
  ];
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full overflow-hidden relative">
      ...
      <div className="w-full bg-white pt-20 pb-28 px-4 md:px-12 text-center">
        ...
        <p className="text-lg md:text-xl text-gray-600 mt-4 max-w-2xl mx-auto">
          Your style journey starts here — curated trends, fast deliveries, and
          unmatched support.
        </p>
