  ...
  return (
    <div className="p-4 space-y-6 bg-gray-50 rounded shadow-sm">
      ...
      <div>
        ...
        {["T-Shirt", "Shirt", "Polo", "Hoodie", "Bottomwear"].map((cat) => (
      ...
      <div>
        ...
        {[
          "Red", "Blue", "Green", "Black", "Yellow", "Pink", "Purple", "Cream",
          "White", "Orange", "Brown", "Maroon", "Grey", "Beige", "Teal", "Navy Blue",
          "Olive", "Turquoise", "Peach", "Lavender"
        ].map((color) => (
